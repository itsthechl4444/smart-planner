...
<head>
  ...
  <style>
    /* Ensure that all clickable cards are displayed as blocks,
       have a pointer cursor, and a sufficient z-index to avoid overlap issues */
    .resource-card {
      display: block;
      cursor: pointer;
      pointer-events: auto;
    ...
    /* (Optional) You may also want to ensure that any nested links/buttons do not interfere */
    .resource-card * {
      pointer-events: auto;
    }
  </style>
...
<body>
    ...
    <main class="main-content">
      ...
      <div class="tips-wrapper">
        <div class="tips-container">
          <!-- Modal trigger links using data-target -->
          <a data-target="modal-time-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Time Management Tips">
            <div class="card-content">
              <h3>Time Management</h3>
              <p>Learn effective techniques to manage your time and boost productivity.</p>
            </div>
          </a>
          <a data-target="modal-budgeting-strategies" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Budgeting Strategies Tips">
            <div class="card-content">
              <h3>Budgeting Strategies</h3>
              <p>Explore proven strategies to create and maintain a successful budget.</p>
            </div>
          </a>
          <a data-target="modal-savings-techniques" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Savings Techniques Tips">
            <div class="card-content">
              <h3>Savings Techniques</h3>
              <p>Discover ways to save effectively and grow your financial security.</p>
            </div>
          </a>
          <a data-target="modal-debt-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Debt Management Tips">
            <div class="card-content">
          ...
          <a data-target="modal-expense-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Expense Management Tips">
            <div class="card-content">
          ...
          <a data-target="modal-project-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Project Management Tips">
            <div class="card-content">
      ...
      <section class="resources-section">
        ...
        <div class="resources-container">
          <a data-target="modal-article-time-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Time Management Article">
            <div class="card-content">
              <h3>Mastering Time Management</h3>
              <p>Dive deep into effective time management techniques with our comprehensive article.</p>
            </div>
          </a>
          <a data-target="modal-article-budgeting" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Budgeting Strategies Article">
            <div class="card-content">
              <h3>Budgeting Strategies</h3>
              <p>Learn the fundamentals of budgeting to take control of your finances.</p>
            </div>
          </a>
          <a data-target="modal-article-productivity" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Productivity Article">
            <div class="card-content">
              <h3>Boosting Productivity</h3>
              <p>Explore advanced strategies to enhance your productivity and efficiency.</p>
            </div>
          </a>
          <a data-target="modal-article-financial-planning" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Financial Planning Article">
            <div class="card-content">
              <h3>Financial Planning Basics</h3>
              <p>Understand the essentials of financial planning for long-term stability.</p>
            </div>
          </a>
          <a data-target="modal-article-task-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Task Management Article">
            <div class="card-content">
      ...
      <section class="resources-section">
        ...
        <div class="resources-container">
          <a data-target="modal-book-rich-dad-poor-dad" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Rich Dad Poor Dad Summary">
            <div class="card-content">
              <h3>Rich Dad Poor Dad</h3>
              <p>Robert T. Kiyosaki</p>
            </div>
          </a>
          <a data-target="modal-book-money-master-the-game" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Money: Master the Game Summary">
            <div class="card-content">
              <h3>Money: Master the Game</h3>
              <p>Tony Robbins</p>
            </div>
          </a>
          <a data-target="modal-book-i-will-teach-you-to-be-rich" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open I Will Teach You to Be Rich Summary">
            <div class="card-content">
              <h3>I Will Teach You to Be Rich</h3>
              <p>Ramit Sethi</p>
            </div>
          </a>
          <a data-target="modal-book-getting-things-done" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Getting Things Done Summary">
            <div class="card-content">
              <h3>Getting Things Done</h3>
              <p>David Allen</p>
            </div>
          </a>
          <a data-target="modal-book-7-habits" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open The 7 Habits Summary">
            <div class="card-content">
              <h3>The 7 Habits</h3>
              <p>Stephen R. Covey</p>
            </div>
          </a>
          <a data-target="modal-book-eat-that-frog" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open Eat That Frog! Summary">
            <div class="card-content">
              <h3>Eat That Frog!</h3>
              <p>Brian Tracy</p>
            </div>
          </a>
          <a data-target="modal-book-pomodoro-technique" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open The Pomodoro Technique Summary">
            <div class="card-content">
              <h3>The Pomodoro Technique</h3>
              <p>Francesco Cirillo</p>
            </div>
          </a>
          <a data-target="modal-book-80-20-principle" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open The 80/20 Principle Summary">
            <div class="card-content">
              <h3>The 80/20 Principle</h3>
              <p>Richard Koch</p>
            </div>
          </a>
          <a data-target="modal-book-checklist-manifesto" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open The Checklist Manifesto Summary">
            <div class="card-content">
              <h3>The Checklist Manifesto</h3>
              <p>Atul Gawande</p>
            </div>
          </a>
          <a data-target="modal-book-total-money-makeover" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="Open The Total Money Makeover Summary">
            <div class="card-content">
      ...
      <section class="resources-section">
        ...
        <div class="resources-container">
          <a data-target="modal-faq-time-management" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="View Time Management FAQs">
            <div class="card-content">
              <h3>Time Management FAQs</h3>
              <p>Find answers to the most common questions about time management.</p>
            </div>
          </a>
          <a data-target="modal-faq-budgeting" href="#!" class="card resource-card modal-trigger" tabindex="0" role="button" aria-label="View Budgeting FAQs">
            <div class="card-content">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      // Initialize Materialize modals and collapsibles
      const modalElems = document.querySelectorAll('.modal');
      M.Modal.init(modalElems);
      const collapsibleElems = document.querySelectorAll('.collapsible');
      M.Collapsible.init(collapsibleElems);

      // (Optional) Initialize Sidebar Toggle if element exists
      ...
      // Initialize custom modal triggers using the data-target attribute
      ...
      // Initialize Carousel
      const carouselElem = document.getElementById('illustration-carousel');
      const carouselInstance = M.Carousel.init(carouselElem, {
        fullWidth: true,
        indicators: false,
        duration: 200,
      });
      ...
      let autoplay = setInterval(() => {
        ...
        carouselInstance.set(currentIndex);
        updateIndicators(currentIndex);
      }, 5000);
