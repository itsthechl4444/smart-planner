...
<body>
    ...
    <div class="app-bar">
        ...
        <h1 class="app-bar-title">Create Account</h1>
        <button type="submit" form="create-account-form" class="save-btn">
    ...
    <main>
        ...
        <div class="container">
            <form id="create-account-form" action="{{ route('accounts.store') }}" method="POST">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" id="balance" name="balance" step="0.01" placeholder="Balance" required>
                </div>
                <div class="form-group">
